        ...
        <div className="lg:container sm:p-2 p-4 px-2 pb-10 pt-0 m-auto">
          ...
          <IsBangla className="">
            <p className="text-2xl mb-6 bfont">
              <strong className="bfont text-2xl">ফিনেক্স কুরিয়ার</strong> এ,
              আমরা বিশ্বাস করি গ্রাহক সহযোগিতা কেবল একটি পরিষেবা নয়—এটি একটি
              প্রতিশ্রুতি। একটি চালান বুকিংয়ের মুহূর্ত থেকে শুরু করে গন্তব্যে
              পৌঁছানো পর্যন্ত, আমাদের গ্রাহকরা সবসময় আমাদের কাজের মূল
              কেন্দ্রবিন্দুতে থাকে। আপনি একটি একক পার্সেল পাঠাচ্ছেন বা বড়
              পরিসরের লজিস্টিকস পরিচালনা করছেন, ফিনেক্স আপনার পাশে রয়েছে একটি
              শক্তিশালী {'"হেল্প ও সাপোর্ট"'} সিস্টেম নিয়ে যা দ্রুত,
              নির্ভরযোগ্য এবং ব্যক্তিগত সহযোগিতা প্রদান করে প্রতিটি ধাপে।
            </p>

            <h3 className="text-3xl font-semibold mb-4 bfont">
              আপনার প্রতি আমাদের প্রতিশ্রুতি
            </h3>
            <p className="mb-6 text-2xl bfont">
              ফিনেক্স কুরিয়ার প্রতিষ্ঠিত হয়েছে এই বিশ্বাসে যে লজিস্টিকস হওয়া
              উচিত স্বচ্ছ, সবার জন্য সহজলভ্য ও গ্রাহককেন্দ্রিক। আমাদের{" "}
              {'"হেল্প ও সাপোর্ট"'} টিম একটি সাধারণ কাস্টমার সার্ভিস বিভাগ
              নয়—এটি আপনার লজিস্টিকস অপারেশনের একটি সম্প্রসারণ। আমরা দ্রুত
              সমস্যার সমাধান, সঠিক দিকনির্দেশনা ও প্রতিটি ইন্টারঅ্যাকশনকে সহজ ও
              সন্তোষজনক করে তোলার জন্য নিবেদিত।
            </p>

            <p className="mb-6 text-2xl bfont">
              আমরা বাংলাদেশজুড়ে ও আন্তর্জাতিকভাবে বৈচিত্র্যময় গ্রাহকদের সেবা
              দিচ্ছি এবং বুঝি যে প্রতিটি গ্রাহকের প্রয়োজন আলাদা। এজন্যই আমরা
              একটি মাল্টি-টিয়ার সাপোর্ট সিস্টেম গড়ে তুলেছি যা ব্যক্তি, ছোট
              ব্যবসা ও বড় কর্পোরেটদের জন্য উপযোগী।
            </p>
            ...
            <div className="space-y-6 bfont">
              <div>
                <h4 className="text-3xl font-bold bfont">
                  ১। ২৪/৭ গ্রাহক সহযোগিতা
                </h4>
                <p className="bfont text-2xl">
                  আমরা জানি যে লজিস্টিকস কখনও থেমে থাকে না। আপনার চালান দিনরাত
                  চলমান—এবং আমরাও তাই। আমাদের সাপোর্ট টিম ২৪ ঘণ্টা, ৭ দিন খোলা
                  থাকে, যাতে আপনি প্রয়োজনে যেকোনো সময় যোগাযোগ করতে পারেন।
                </p>
                <ul className="list-disc list-inside ml-4">
                  <li className="text-2xl bfont">
              ...
              <div>
                <h4 className="font-bold bfont text-3xl">
                  ২। রিয়েল-টাইম চালান ট্র্যাকিং
                </h4>
                <p className="bfont text-2xl">
                  স্বচ্ছতা আমাদের সাপোর্টের মূলনীতি। আমাদের উন্নত ট্র্যাকিং
                  সিস্টেমের মাধ্যমে আপনি রিয়েল-টাইমে আপনার চালানের অবস্থান
                  জানতে পারবেন। যেকোনো সন্দেহ থাকলে, আমাদের টিম সাথে সাথে আপডেট
                  দিতে প্রস্তুত।
                </p>
                <ul className="list-disc list-inside ml-4">
                  <li className="text-2xl bfont">
              ...
              <div>
                ...
                <p className="bfont text-2xl">
                  বাংলাদেশ একটি ভাষাগতভাবে বৈচিত্র্যময় দেশ। ফিনেক্স বাংলা ও
                  ইংরেজিতে সাপোর্ট প্রদান করে যাতে প্রত্যেকেই সহজে এবং
                  স্বাচ্ছন্দ্যে যোগাযোগ করতে পারেন।
                </p>
              </div>
            </div>

            <h3 className="text-3xl font-semibold mt-10 mb-4 bfont">
              আমরা যেসব সহযোগিতা প্রদান করি
            </h3>
            <ul className="list-disc list-inside ml-4 mb-6">
              <li className="bfont text-2xl">
                <strong className="bfont text-2xl">
                  চালান বুকিং সহযোগিতা:
                </strong>{" "}
                বুকিং গাইড, পরিষেবা নির্বাচন ও রুট পরিকল্পনা।
              </li>
              <li className="bfont text-2xl">
                <strong className="bfont text-2xl">
                  কাস্টমস ও ডকুমেন্টেশন সহযোগিতা:
                </strong>{" "}
                ডিক্লারেশন, আমদানি/রপ্তানি আইন ও কাগজপত্র নিয়ে সহযোগিতা।
              </li>
              <li className="bfont text-2xl">
                <strong className="bfont text-2xl">
                  হারিয়ে যাওয়া বা বিলম্বিত চালান:
                </strong>{" "}
                তদন্ত ও তাত্ক্ষণিক আপডেট প্রদান।
              </li>
              <li className="bfont text-2xl">
                <strong className="bfont text-2xl">
                  দাবি ও ইনস্যুরেন্স সহযোগিতা:
                </strong>{" "}
                দ্রুত যাচাই ও ক্ষতিপূরণ প্রক্রিয়া।
              </li>
              <li className="bfont text-2xl">
                <strong className="bfont text-2xl">
                  পরিষেবা ফিডব্যাক ও অভিযোগ:
                </strong>{" "}
                প্রতিক্রিয়ার ভিত্তিতে সমস্যা সমাধান।
              </li>
            </ul>
            ...
            <p className="mb-6 bfont text-2xl">
              আমাদের মোবাইল অ্যাপের মাধ্যমে আপনি লাইভ চ্যাট, ট্র্যাকিং, FAQ,
              টিকিট সাবমিশন এবং নিকটবর্তী সার্ভিস সেন্টার খুঁজে পেতে পারবেন।
              অ্যাপটি iOS ও Android উভয় প্ল্যাটফর্মে উপলব্ধ।
            </p>
            ...
            <p className="mb-6 bfont text-2xl">
              আমাদের অনলাইন হেল্প সেন্টার পরিদর্শন করুন যেখানে আপনি গাইড,
              টিউটোরিয়াল, কাস্টমস তথ্য এবং FAQ-এর উত্তর পাবেন, যা আপনাকে
              আত্মবিশ্বাসের সাথে সমস্যা সমাধান করতে সাহায্য করবে।
            </p>
            ...
            <p className="mb-6 bfont text-2xl">
              প্রতিটি টিকিট, কল বা চ্যাট দক্ষ ও সহানুভূতিশীল সাপোর্ট এজেন্ট
              দ্বারা পরিচালিত হয়, যাতে আপনি সবসময় মানবিক ও নির্ভরযোগ্য
              সহযোগিতা পান।
            </p>
            ...
            <p className="mb-6 bfont text-2xl">
              আমাদের দেশেরব্যাপী সার্ভিস সেন্টারসমূহে আপনি সামনা-সামনি সহযোগিতা,
              প্যাকেজিং সাপোর্ট, উপকরণ কেনাকাটা ও ব্যবসা শুরু করার সহযোগিতা
              পাবেন।
            </p>
            ...
            <p className="mb-6 bfont text-2xl">
              আমাদের উন্নয়নের জন্য আপনার অভিজ্ঞতা জানানো জরুরি। অ্যাপ,
              ওয়েবসাইট, অ্যাকাউন্ট ম্যানেজার অথবা সোশ্যাল মিডিয়ার মাধ্যমে
              মতামত দিন।
            </p>

            <h3 className="text-3xl font-semibold mb-4 bfont">উপসংহার</h3>
            <p className="mb-6 bfont text-2xl">
              ফিনেক্স কুরিয়ার কেবল পার্সেল ডেলিভারি করে না—আমরা মানসিক
              প্রশান্তি পৌঁছে দিই। আমাদের {'"হেল্প ও সাপোর্ট"'} টিম হলো আমাদের
              প্রতিশ্রুতির মেরুদণ্ড—যা আপনাকে আন্তরিকতা, নির্ভরযোগ্যতা ও যত্নের
              সাথে সেবা দেয়। আপনি হোন নতুন গ্রাহক কিংবা দীর্ঘমেয়াদী
              অংশীদার—আমরা আছি আপনার পাশে।
            </p>
            ...
            <div className="mt-10 bg-gray-100 p-6 rounded-xl shadow">
              ...
              <p className="mb-4 bfont text-2xl">
                আমাদের সাথে যেকোনো সময় যোগাযোগ করুন। আমরা আছি আপনার সাফল্যের
                পাশে:
              </p>
              <ul className="list-none mb-4 bfont">
                <li className="bfont text-2xl">
                  <strong className="bfont text-2xl">ফোন:</strong> +880
                  1645-034000, +880 1577-057714
                </li>
                <li className="bfont text-2xl">
                  <strong className="bfont text-2xl">ইমেইল:</strong>{" "}
                  info@finex.ltd & finex.in.ex@gmail.com
                </li>
                <li className="bfont text-2xl">
                  <strong className="bfont text-2xl">লাইভ চ্যাট:</strong>{" "}
                  WhatsApp ও Facebook Messenger এর মাধ্যমে{" "}
                </li>
              </ul>
              <p className="bfont text-2xl">
                আপনার মতামত আমাদেরকে আরও ভালো করতে সহযোগিতা করে। কিভাবে আমরা আরও
                ভালো হতে পারি জানাতে ভুলবেন না!
              </p>
            </div>
          </IsBangla>
        </div>
