...
const StaffDashBoardPickupListViewPopup = ({ pickupData }) => {
  return (
    <Modal>
        ...
        <table className="w-full">
          <tbody className="w-full">
            ...
            <tr>
              <td>Accept Time: </td>
              <td>
                {new Date(pickupData?.isConfirm?.dateTime).toLocaleDateString()}
                -
                {new Date(pickupData?.isConfirm?.dateTime).toLocaleTimeString()}
              </td>
            </tr>
          </tbody>
        </table>
...
export default StaffDashBoardPickupListViewPopup;
