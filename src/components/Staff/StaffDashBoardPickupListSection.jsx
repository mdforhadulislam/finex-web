...
import StaffDashBoardPickupListBox from "./StaffDashBoardPickupListBox";
import StaffDashBoardPickupListViewPopup from "./StaffDashBoardPickupListViewPopup";
import {
  getRequestSend,
  PICKUP_API,
  PICKUP_CONFIRM_API,
...
const StaffDashBoardPickupListSection = () => {
  ...
  return (
    <div className="w-full h-auto py-2" id="pickup">
      <div className=" w-full h-auto p-2 shadow-3xl rounded-md pb-5">
        ...
        <StaffDashBoardPickupListViewPopup pickupData={selectedPickupData} />
      </div>
    </div>
  );
};

export default StaffDashBoardPickupListSection;
