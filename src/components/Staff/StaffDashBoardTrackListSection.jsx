...
import StaffDashBoardTrackListBox from "./StaffDashBoardTrackListBox";
import StaffDashBoardTrackListDetailsPopup from "./StaffDashBoardTrackListDetailsPopup";

const StaffDashBoardTrackListSection = () => {
  ...
  return (
    <div>
      <div className="w-full h-auto py-2" id="Alltracking">
          ...
          <div className="w-full h-auto flex flex-col gap-3 p-2">
            {trackData?.map((item, index) => (
              <div className="w-full h-auto relative" key={index}>
                <StaffDashBoardTrackListBox trackData={item} />
                ...
                <div className="flex gap-2 absolute right-1 z-10 top-[3%] flex-col">
                  ...
                  <FiEdit
                    ...
                    onClick={() => {
                      router.push(`/staff/track/update/${item.ourTrackingId}`);
                    }}
                  />
                </div>
              </div>
      ...
      <StaffDashBoardTrackListDetailsPopup trackData={viewTrackParcelData} />
    </div>
  );
};

export default StaffDashBoardTrackListSection;
