...
const UserDashBoardOrderListBox = ({ orderData }) => {
  return (
    <div className="w-full h-auto shadow-3xl rounded-md p-2">
      <div className="w-full h-auto grid grid-cols-1 grid-rows-3 sm:grid-cols-2 sm:grid-rows-2 md:grid-cols-3 md:grid-rows-1 relative">
        <div className="w-full h-auto flex flex-col gap-1 text-sm">
          <div className="text-lg font-semibold flex justify-start items-center align-middle gap-3">
            Sender <FaArrowAltCircleDown className="w-5 h-5" />
          </div>
        ...
        <div className="w-full h-auto flex flex-col gap-1  text-sm">
          <div className="text-lg font-semibold  flex justify-start items-center align-middle gap-3">
            Reciver <FaArrowAltCircleDown className="w-5 h-5" />
          </div>
        ...
        <div className="w-full h-auto flex flex-col gap-1  text-sm">
          <div className="text-lg font-semibold  flex justify-start items-center align-middle gap-3">
            Details <FaArrowAltCircleDown className="w-5 h-5" />
          </div>
          ...
          <div>
            Total Payment Recived: {Number(orderData?.payment?.pRecived)}
          </div>
        </div>
      </div>
    </div>
...
export default UserDashBoardOrderListBox;
