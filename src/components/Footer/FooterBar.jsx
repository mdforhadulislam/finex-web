    ...
    <footer className="container h-auto m-auto p-5 pb-0">
      <div className="md:border-t py-16 text-[17px] text-gray-800">
        ...
        <div className="grid gap-2 md:hidden">
          ...
          >
            <div className="mt-2 space-y-2">
              {FooterLinks.Service.map((item, idx) => (
                ...
                >
                  <IsEnglish>{item.title}</IsEnglish>
                  <IsBangla className={'bfont text-2xl hover:text-defult'} >{item.titleBn}</IsBangla>
                </Link>
              ))}
            </div>
          </Collapse>
          ...
          <Collapse title={`${lang.isEnglish ? "Contact Us" : ""} ${
        ...
        <div className="grid-cols-2  gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4 hidden md:grid">
          <div>
            ...
            <div className="mt-2 space-y-2">
              {FooterLinks.Service.map((item, idx) => (
                ...
                >
                  <IsEnglish>{item.title}</IsEnglish>
                  <IsBangla className={'text-2xl bfont text-gray-600 hover:text-defult'}>{item.titleBn}</IsBangla>
                </Link>
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-2 text-sm">
              ...
              <IsBangla>
                <p className="transition-colors duration-300 hover:text-defult">
                  <a href="tel:+8801577185840" className="bfont text-2xl text-gray-600">মোবাইল ফোনঃ +৮৮০ ১৫৭৭-১৮৫৮৪০</a>
                </p>
              </IsBangla>
