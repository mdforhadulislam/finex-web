...
const AdminDashBoardTrackParcelListSection = () => {
  ...
  return (
    <div>
          ...
          <div className="w-full h-auto flex flex-col gap-3 p-2">
            {trackData?.map((item, index) => (
              <div className="w-full h-auto relative" key={index}>
                <AdminDashBoardTrackParcelListSectionBox trackData={item} />
                ...
                <div className="flex gap-2 absolute right-1 z-10 top-[3%] flex-col">
                  ...
                  <FiEdit
                    ...
                    onClick={() => {
                      router.push(`/admin/track/update/${item.ourTrackingId}`)
                    }}
                  />
                </div>
              </div>
      ...
      <AdminDashBoardTrackParcelPopup trackData={viewTrackParcelData}  />
    </div>
  );
};

export default AdminDashBoardTrackParcelListSection;
