...
import AdminDashBoardOrderListSectionBox from "./AdminDashBoardOrderListSectionBox";
import { ModalContext } from "@/context/ModalContext";
import AdminDashBoardOrderCreatedPopup from "./AdminDashBoardOrderCreatedPopup";
...
const AdminDashBoardOrderListSection = () => {
  ...
  return (
    <div className="w-full h-auto py-2" id="allorderlist">
      ...
      <AdminDashBoardOrderCreatedPopup orderData={viewOrderData} />
    </div>
  );
};

export default AdminDashBoardOrderListSection;
