...
export const LOGIN_API = `https://finex-server.onrender.com/auth/login/`
export const REGISTER_API = `https://finex-server.onrender.com/auth/register/`
export const LOGOUT_API = `https://finex-server.onrender.com/auth/logout/`
