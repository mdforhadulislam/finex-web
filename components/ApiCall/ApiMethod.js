...
export const LOGIN_API = `https://finex-server.onrender.com/api/v1/auth/login/`
export const REGISTER_API = `https://finex-server.onrender.com/api/v1/auth/register/`
export const LOGOUT_API = `https://finex-server.onrender.com/api/v1/auth/logout/`
...
export const FEEDBACK_API = `${ROOT_API_V1}utils/feedback/`
