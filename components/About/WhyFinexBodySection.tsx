...
export const aboutData = [
  {
    ...
    titleBn: "গ্রাহক সেবা",
    detailsBn:
      "আমাদের গ্রাহক পরিষেবা সেলগুলি আপনার সমস্ত প্রশ্নের জন্য দ্রুত প্রতিক্রিয়া প্রদান করে। আন্তঃনগর পিক-আপ এবং ডেলিভারিতে আমাদের গাড়ির বহর দ্রুত এবং নিরাপদ ডেলিভারি প্রদান করে।",
    details:
  ...
  },
  {
    ...
    titleBn: "মানসম্পন্ন সেবা",
    detailsBn:
      "ফিনেক্স তার আন্তর্জাতিক মানের মানের পরিষেবার জন্য বিখ্যাত। আমাদের ব্যাপক জ্ঞান, বোঝাপড়া এবং চমৎকার বিদেশী এজেন্ট নেটওয়ার্ক আমাদের বিশ্বব্যাপী গন্তব্যে পৌঁছাতে সক্ষম করেছে। ক্লায়েন্টরা আমাদের উচ্চতর মানের নিয়ন্ত্রণ ব্যবস্থা এবং সময়মত ডেলিভারির প্রশংসা করে।",
    details:
  ...
  },
  {
    ...
    titleBn: "আমাদের ভিশন",
    detailsBn:
      "আমাদের দৃষ্টি প্রতিযোগীতামূলক হারে পেশাদার, প্রম্পট এবং বিনয়ী কুরিয়ার পরিষেবা প্রদান করা। আমরা আমাদের দক্ষতা, প্রযুক্তি এবং অংশীদারিত্বগুলিকে আমাদের গ্রাহকদের চাহিদার জন্য উদ্ভাবনী লজিস্টিক সমাধানগুলি সরবরাহ করার জন্য, উচ্চ স্তরের গুণমান, নিরাপত্তা এবং সুরক্ষা বজায় রেখে ব্যবহার করি।",
    details:
          ...
          <div className="w-full md:w-[50%] lg:w-[65%] h-auto p-5">
            ...
            <IsEnglish className="">
              <div className="w-full h-auto  text-gray-900 ">
                For a fast, reliable, and secure courier service, Faster
                International Express (FINEX) is your best choice! We don’t just
                deliver parcels—we deliver peace of mind by ensuring the safety
                and timely arrival of every shipment. <br />
                As an independent courier service provider, we guarantee the
                highest level of professionalism and personalized care in every
                delivery. With our strong local network across Surat, we stand
                apart from competitors by providing faster and more efficient
                services.
                <br />
                <br />
                <b className="text-2xl text-gray-900">Why FINEX?</b> <br />
                <ul>
                  <li className="text-gray-900  ">
                    <GoCheck className="w-[26px] h-[26px] bg-green-500 text-white  rounded-md border p-[2px] font-bold inline" />{" "}
                    Fast & Secure Delivery – Ensuring on-time arrival
                  </li>
                  <li className="text-gray-900 ">
                    <GoCheck className="w-[26px] h-[26px] bg-green-500 text-white  rounded-md border p-[2px] font-bold inline" />{" "}
                    Hassle-Free Service – Reliable and professional customer
                    support
                  </li>
                  <li className="text-gray-900 ">
                    <GoCheck className="w-[26px] h-[26px] bg-green-500 text-white  rounded-md border p-[2px] font-bold inline" />{" "}
                    Maximum Flexibility – Customized shipping options to meet
                    your needs
                  </li>
                  <li className="text-gray-900 ">
                    <GoCheck className="w-[26px] h-[26px] bg-green-500 text-white  rounded-md border p-[2px] font-bold inline" />{" "}
                    Serving with Excellence Since 2023 – Years of experience and
                    trusted by happy clients
                  </li>
                </ul>
                <br />
                We understand that flexibility is the key to success. That’s why
                we offer route adjustments, scheduling adaptability, and
                personalized services tailored to your specific
                requirements—helping your business run smoothly.
                <br />
                <br />
                <b className=" text-gray-900 font-bold ">
                  Ship with FINEX – Experience fast, secure, and trusted
                  delivery! 🚀📦
                </b>
              </div>
            </IsEnglish>
              ...
              <div className="w-full h-auto text-2xl text-gray-900 bfont">
                ...
                <ul>
                  <li className="text-gray-900 bfont text-2xl">
                    <GoCheck className="w-[26px] h-[26px] bg-green-500 text-white  rounded-md border p-[2px] font-bold inline" />{" "}
                    দ্রুত ও নিরাপদ ডেলিভারি – সময়মতো পৌঁছানোর নিশ্চয়তা
                  </li>
                  <li className="text-gray-900 bfont text-2xl">
                    <GoCheck className="w-[26px] h-[26px] bg-green-500 text-white  rounded-md border p-[2px] font-bold inline" />{" "}
                    সম্পূর্ণ ঝামেলা-মুক্ত পরিষেবা – নির্ভরযোগ্য ও পেশাদার
                    কাস্টমার সাপোর্ট
                  </li>
                  <li className="text-gray-900 bfont text-2xl">
                    <GoCheck className="w-[26px] h-[26px] bg-green-500 text-white  rounded-md border p-[2px] font-bold inline" />{" "}
                    সর্বোচ্চ নমনীয়তা – আপনার চাহিদা অনুযায়ী কাস্টমাইজড শিপিং
                    অপশন
                  </li>
                  <li className="text-gray-900 bfont text-2xl">
                    <GoCheck className="w-[26px] h-[26px] bg-green-500 text-white  rounded-md border p-[2px] font-bold inline" />{" "}
                    ২০২৩ সাল থেকে সাফল্যের সাথে পরিষেবা – দীর্ঘদিনের অভিজ্ঞতা ও
                    খুশি ক্লায়েন্টদের বিশ্বাস
                  </li>
                </ul>
                <br />
